...
const Login = () => {
  return (
    <div className="  w-full h-screen flex justify-center items-center bg-[url('/netflix-bg.jpg')]  ">
      ...
      >
        <h1 className="absolute  top-10 left-14 font-extrabold capitalize tracking-wide">
          sign in
        </h1>
        <label htmlFor="email">
          <input
        ...
        <button className="bg-red-600 px-16 py-0.5 font-extrabold tracking-wide cursor-pointer">
          Sign In
        </button>

        <Link to={"/register"}>
          <h1 className="underline font-bold md:no-underline md:hover:underline">Don't Have An account?</h1>
        </Link>
      </form>
    </div>
  );
